...
export const api_v1_horoscope_list = createAsyncThunk("horoscopes/api_v1_horoscope_list", async payload => {
  const response = await apiService.api_v1_horoscope_list(payload);
  return response.data;
});
export const api_v1_horoscope_create = createAsyncThunk("horoscopes/api_v1_horoscope_create", async payload => {
  const response = await apiService.api_v1_horoscope_create(payload);
  return response.data;
});
export const api_v1_horoscope_retrieve = createAsyncThunk("horoscopes/api_v1_horoscope_retrieve", async payload => {
  const response = await apiService.api_v1_horoscope_retrieve(payload);
  return response.data;
});
export const api_v1_horoscope_update = createAsyncThunk("horoscopes/api_v1_horoscope_update", async payload => {
  const response = await apiService.api_v1_horoscope_update(payload);
  return response.data;
});
export const api_v1_horoscope_partial_update = createAsyncThunk("horoscopes/api_v1_horoscope_partial_update", async payload => {
  const response = await apiService.api_v1_horoscope_partial_update(payload);
  return response.data;
});
export const api_v1_horoscope_destroy = createAsyncThunk("horoscopes/api_v1_horoscope_destroy", async payload => {
